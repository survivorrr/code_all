			...
			<table>
				<tr>
					...
					<td colspan="2"><input name="adminCode"
						value="${param.adminCode }" type="text" class="width150" /></td>
					<td class="login_error_info"><span class="required">30长度的字母、数字和下划线</span></td>
				</tr>
				<tr>
					<td class="login_info">密码：</td>
					<td colspan="2"><input name="password"
						value="${param.password }" type="password" class="width150" /></td>
				...
				<tr>
                    ...
                    'src','createImg.do?x='+Math.random());"
				...
				<tr>
					...
					<td class="login_button" colspan="2">
						<!-- 
                         1.表单有onsubmit时间，点击submit按钮，就是为了触发这个事件
                    	        可以提交表单。
                    	 2.表单还有submit()，调用此方法一样可以提交表单
                    	 3.在超链接上可以写js，但必须进行声明，语法:
                    	   javascript:js 代码; --> <a

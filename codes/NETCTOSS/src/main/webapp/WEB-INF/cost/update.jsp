	...
	<div id="main">
		...
		<form action="updateCost.do" method="post" class="main_form">
			...
			<div class="input_info">
				<input type="text" class="readonly" name="id" readonly
					value="${cost.costId }" />
			</div>
			<div class="text_info clearfix">
				<span>资费名称：</span>
			...
			<div class="input_info fee_type">
				<!-- req.getAttribute("cost").getCostType()==1 -->
				<input type="radio" name="costType" value="1"
					<c:if test="${cost.costType==1 }">checked</c:if> id="monthly"
					onclick="feeTypeChange(1);" /> <label for="monthly">包月</label> <input
					type="radio" name="costType" value="2"
					${cost.costType==2?'checked':'' } id="package"
					onclick="feeTypeChange(2);" /> <label for="package">套餐</label> <input
					type="radio" name="costType" value="3"
					${cost.costType==3?'checked':'' } id="timeBased"
			...
			<div class="input_info">
				<input type="text" name="baseDuration" value="${cost.baseDuration }"
			...
			<div class="input_info">
				<input type="text" name="baseCost" value="${cost.baseCost }"
			...
			<div class="input_info">
				<input type="text" name="unitCost" value="${cost.unitCost }"
